...
export default function GymAd() {
  ...
  return (
    <section className="mx-auto max-w-2xl pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8 flex flex-col md:flex-row items-center justify-between gap-10 border border-linegrey rounded-2xl m-4 shadow-xl p-6 md:p-10 font-[Poppins] bg-gradient-to-br from-lightblue to-white">
