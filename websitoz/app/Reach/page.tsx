    ...
    <section className="flex flex-col md:flex-row items-center justify-between gap-10 border border-gray-200 rounded-2xl m-4 max-w-7xl w-full shadow-xl p-6 md:p-10 font-[Poppins] mx-auto bg-gradient-to-br from-pink-50 to-white">
      ...
      <div className="flex flex-col text-center md:text-left items-center md:items-start w-full md:w-1/2">
        ...
        <div className="flex flex-wrap justify-center md:justify-start gap-4 mt-10">
          <Link
            href="/gym"
            className="px-6 py-2 bg-blue from-pink-500 to-rose-600 text-white font-medium rounded-full shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105"
          >
            Build Gym Website
          </Link>
          ...
          <Link
            href="/travel"
            className="px-6 py-2 bg-blue from-blue-500 to-cyan-600 text-white font-medium rounded-full shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105"
          >
          ...
          <Link
            href="/learning"
            className="px-6 py-2 bg-blue from-purple-500 to-violet-600 text-white font-medium rounded-full shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105"
          >
