    ...
    return (
        <div className='mx-auto max-w-7xl sm:py-4 lg:px-8 m-32'>
            ...
            <div className='grid grid-cols-1 my-16'>
                <Image src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1170" alt="office-image" height={684} width={1296} />
            </div>
        </div>
    )
}
